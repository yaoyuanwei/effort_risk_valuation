# hBayesDM Model Function tailored for the one-option cost-benefit decision-making task

hBayesDM_egt <- function(task_name,
                           model_name,
                           model_type = "",
                           data_columns,
                           parameters,
