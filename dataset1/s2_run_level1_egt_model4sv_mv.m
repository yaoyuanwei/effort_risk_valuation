...
for i = 1:subnum
    ...
    if ~ismember(sid, no_rall)
        run_n   = runnum;
        load(fullfile(exp_dir, 'spm_model', 'egt_model3.mat'));
        
        fimg1   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun1'), '^wr.*\.nii$', Inf);
        fimg2   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun2'), '^wr.*\.nii$', Inf);
        fimg3   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun3'), '^wr.*\.nii$', Inf);
        fimg4   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun4'), '^wr.*\.nii$', Inf);
        fimg5   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun5'), '^wr.*\.nii$', Inf);
    ...
    % sub with 4 runs
        ...
        load(fullfile(exp_dir, 'spm_model', 'egt_model3_4r.mat'));      
        
        % no run1
        if ismember(sid, no_r1)       
            fimg1   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun2'), '^wr.*\.nii$', Inf);
            fimg2   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun3'), '^wr.*\.nii$', Inf);
            fimg3   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun4'), '^wr.*\.nii$', Inf);
            fimg4   = spm_select('ExtFPListRec', fullfile(sub_fold,'fun5'), '^wr.*\.nii$', Inf);
